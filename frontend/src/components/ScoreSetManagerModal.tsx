...
export default function ScoreSetManagerModal({
  ...
  const content = (
      <div
        className={embedded ? 'bg-white w-full h-full flex flex-col min-h-0 rounded-xl overflow-hidden' : 'bg-white w-full max-w-6xl rounded-xl shadow-xl max-h-[88vh] overflow-hidden'}
      ...
      >
        ...
        <div className={embedded ? 'grid grid-cols-1 md:grid-cols-[220px_1fr] flex-1 min-h-0 overflow-hidden' : 'grid grid-cols-1 md:grid-cols-[220px_1fr] min-h-[520px]'}>
