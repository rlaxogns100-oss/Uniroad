...
async def generate_visual_report_data(
    ...
    *,
    ...
    page1_task = _generate_json(_page1_prompt(student_name, context), max_output_tokens=3072)
    page2_task = _generate_json(_page2_prompt(student_name, context), max_output_tokens=4096)
    page3_task = _generate_json(_page3_prompt(student_name, context), max_output_tokens=4096)
    page4_task = _generate_json(_page4_prompt(student_name, context), max_output_tokens=4096)
